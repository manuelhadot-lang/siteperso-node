...
export let simulationResults = { voltmeters: {}, ammeters: {}, leds: {} };
...
export let counters = { battery: 0, resistor: 0, nand: 0, d_flipflop: 0, jk_flipflop: 0, led: 0, voltmeter: 0, junction: 0, gnd: 0, vcc: 0, logic_terminal: 0, gimp: 0 };
export let circuit = {
    components: [],
    wires: [],
    autoJunctions: []
