...
// Pas de « -f rc » : option inexistante dans ngspice-46 (bascule en interactif, sans
// exécuter ni écrire le log). digital.cm est chargé par spinit (../lib/ngspice/digital.cm).
try {
    ...
    let tail = "";
    try {
        tail = readFileSync(join(dir, log), "utf8");
    } catch {
        /* ngspice n'a pas écrit de log */
    }
